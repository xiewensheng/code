    ...
    <div class="operateBox clearfixed">
        <form action="/bk/Admin/Page/updateInfo/token/<?php echo ($token); ?>" method="post"  enctype="multipart/form-data">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="index_title" value="<?php echo ($info[5]['value']); ?>">
            </div>
            <div class="form-group col-md-6">
                <label for="index_text">INDEX_TEXT</label>
                <input type="text" class="form-control" name="index_text" value="<?php echo ($info[4]['value']); ?>">
            </div>
            <div class="form-group col-md-6">
                <label for="extend_title">EXTEND_TITLE</label>
                <input type="text" class="form-control" name="extend_title" value="<?php echo ($info[2]['value']); ?>">
            </div>
            <div class="form-group col-md-6">
                <label for="extend_text">EXTEND_TEXT</label>
                <input type="text" class="form-control" name="extend_text" value="<?php echo ($info[1]['value']); ?>">
            </div>
            <div class="form-group col-md-6">
            ...
            <div id="preview">
                <img id="imghead" src="/bk/Application/Admin/Public/Uploads/<?php echo ($info[3]['value']); ?>">
            </div>


            <div class="form-group col-md-6">
                <label for="EXTEND_IMG">EXTEND_IMG</label>
                <input type="file" class="form-control" name="EXTEND_IMG" onchange="previewImageone(this)" accept="image/*" />
            </div>
            <div id="preview_one" class="test">
                <img id="imghead1" src="/bk/Application/Admin/Public/Uploads/<?php echo ($info[0]['value']); ?>">
            </div>
